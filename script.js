document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(45) hue-rotate(-25deg) brightness(1.1) contrast(0.5)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(45) hue-rotate(-25deg) brightness(1.1) contrast(0.5)'; // Adjusted filter values
    }
