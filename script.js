document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(2.5) hue-rotate(-45deg) brightness(0,9) contrast(1.7)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(2.5) hue-rotate(-45deg) brightness(0.9) contrast(1.7)'; // Adjusted filter values
    }
