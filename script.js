document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(50) hue-rotate(-20deg) brightness(1.2)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(50) hue-rotate(-20deg) brightness(1.2)'; // Adjusted filter values
    }
